                ...
                <div className=' flex p-10  text-center gap-5 justify-center  '>
                    <div
                        ...
                        <div className='flex bg-gray-100 h-11 border hover:bg-yellow-100'>
                            ...
                            <h1 className='pl-2 pt-1 text-center font-bold w-full cursor-pointer' onClick={() => { navigate('/orderlist') }}>Bookings</h1>
                        </div>
                        <div className='flex bg-gray-100 h-11 border hover:bg-yellow-100 '>

                            <h1 className='pl-2 pt-1 text-center font-bold w-full cursor-pointer'>Logout</h1>
                        </div>
                    ...
                    <div className='w-7/12  flex flex-row rounded-lg border-2  border-lime-400  '>
                        ...
                        <form onSubmit={submitProfile} className='w-full m-14  flex flex-col rounded-lg shadow-md shadow-white' >
                    ...
                    <div className=''>
                        <button onClick={() => { navigate('/edit') }} className="text-white border bg-lime-500 hover:bg-[#050708]/80 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#050708]/40 dark:focus:bg-lime-200 me-2 mb-2" >
                            Edit
                        </button>
