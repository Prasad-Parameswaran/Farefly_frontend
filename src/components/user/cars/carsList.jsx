                ...
                <div className='w-[70%] h-full '>
                    ...
                    <div className='w-[95%] h-[80%] overflow-y-scroll no-scrollbar '>
                        ...
                        {cars.length > 0 ? cars.map((value, index) => (
                            ...
                            : 'https://www.freepik.com/free-vector/car-free-day-emblem-icon-isolated_88800071.htm#query=no%20car%20icon&position=8&from_view=keyword&track=ais&uuid=e1cb98ff-cbc2-4121-9458-5ed318448aad'
